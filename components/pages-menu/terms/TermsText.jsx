  ...
  return (
    <>
      <div className="text-box">
        <h3>THIS AGREEMENT GOVERNS YOUR USE OF Immense Career INC. HOSTED SERVICES.</h3>
        <p>
        ...
        <p>
          You may not access the Hosted Services if You are Immense Career’s direct competitor, except with Immense Career’s prior written consent. In addition, you may not access the Hosted Services for purposes of monitoring their availability, performance or functionality, or for any other benchmarking or competitive purposes.
        </p>
        <p>
          This agreement was last updated on Apr 11, 2023 (“Agreement”). It is effective between You and Immense Career Inc. as of the date of You accepted this Agreement (the “Effective Date“).
        </p>
        <p>
      ...
      <div className="text-box">
        ...
        <p>
          “Customer Trademarks” means any trademarks that Customer provides Immense Career for the purpose of referring to Customer within the user interface for the Hosted Service.
        </p>
        <p>
          “Dispute Period” means fifteen (15) days from receipt of invoice.
        </p>
        <p>
          “Documentation” means Immense Career’s then current on-line help, guides, and manuals published by Immense Career and made generally available by Immense Career for the Hosted Services. Documentation shall include any updated Documentation that Immense Career provides.
        </p>
        <p>
        ...
        <p>
          “Order Form” means the ordering documents for Customer purchases from Immense Career that are executed hereunder by Customer and Immense Career from time to time. All Order Forms shall be deemed incorporated herein. The initial Order Form is attached hereto as Exhibit A.
        </p>
        <p>
      ...
      <div className="text-box">
        <h3>4. OWNERSHIP</h3>
        <p>
          4.1 &nbsp;&nbsp;&nbsp; Immense Career shall own and retain all right, title and interest in and to the Hosted Services and Immense Career Confidential Information (defined below), including all intellectual property rights. No rights are granted to Customer hereunder other than as expressly set forth herein.
        </p>
        <p>
          4.2 &nbsp;&nbsp;&nbsp; Immense Career shall have a royalty-free, worldwide, transferable, sublicensable, irrevocable, perpetual license to use or incorporate into the Hosted Services any suggestions, enhancement requests, recommendations or other feedback provided by Customer, including Users, relating to the operation of the Hosted Services.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          5.1 &nbsp;&nbsp;&nbsp; Customer agrees to pay within 30 days of receiving an invoice for all Hosted Services ordered. Except as otherwise provided: (i) the Hosted Services fees for the first Subscription Term set forth in each Order Form hereunder will be invoiced upon execution of such Order Form; and (ii) subsequent fees under any applicable Order Form will be invoiced, if applicable, in advance approximately thirty (30) days prior to the start of each subsequent Subscription Term or charged automatically at the start of each subsequent Subscription Term; provided, however, that if the subsequent Subscription Term begins on the 28th, 29th, 30th, or 31st day of the month, Customer may be automatically charged on the 27th day of the applicable month.  All fees under this Agreement are nonrefundable except as otherwise set forth herein. Immense Career’s fees are exclusive of all taxes, levies, or duties imposed by taxing authorities, and Customer shall be responsible for payment of all such taxes, levies, or duties, even if such amounts are not listed by Immense Career. Invoices for all Hosted Services in the amount less than $1,000/month shall be paid via credit card or ACH bank payments, other invoices may be paid via credit card or ACH bank payments for no additional fee or via check which shall incur an additional $4/location/month processing fee.
        </p>
        <p>
          5.2 &nbsp;&nbsp;&nbsp; Except as otherwise provided in an Order Form, payment for invoices is due within thirty (30) days of Customer’s receipt of the applicable invoice (excluding amounts under reasonable and good faith dispute).  If any amounts are withheld by Customer, Customer shall, within the Dispute Period provide Immense Career a reasonably detailed written explanation of the nature of the dispute, which explanation shall set forth the dollar amounts withheld and the reasons for withholding such amounts.  If Customer does not dispute the applicable invoice during the Dispute Period, any such dispute shall be deemed waived.  For clarity, Customer remains obligated to pay Immense Career for all portions of the applicable invoice that are not under reasonable and good faith dispute.  Overdue amounts may result in suspension of Customer’s ability to access the Hosted Service until payment is made.  Customer shall reimburse Immense Career for all reasonable, actual costs (including reasonable attorneys’ fees) incurred by Immense Career in the collection of overdue amounts. Accounts with delinquent payments past 90 days may be suspended until all payments are made in full.
        </p>
      </div>
      ...
      <div className="text-box">
        <h3>6. SUPPORT</h3>
        <p>
          For the Subscription Term Immense Career shall provide assistance to Customer by telephone, e-mail or online chat as communicated to Customer. Immense Career shall use reasonable commercial efforts to correct at no additional charge any reproducible errors reported by Customer. Immense Career shall review all requests for improvements and new functionality, but Immense Career shall have no obligation to provide any modifications to the Hosted Service.
        </p>
      </div>

      <div className="text-box">
        <h3>7. LIMITED REPRESENTATIONS AND WARRANTIES</h3>
        <p>
          Each Party represents and warrants that it has the power and authority to enter into this Agreement. Immense Career warrants that (i) it will provide the Hosted Service in a manner consistent with generally accepted industry standards, (ii) the Hosted Service will perform substantially in accordance with its online Documentation under normal use, (iii) the functionality of the Hosted Service will not be materially decreased during a subscription term; (iv) the configuration of the Hosted Services will conform in all material respects to this Agreement and/or the applicable Order Form;  and (v) the Hosted Service will not contain or transmit to Customer any Malicious Code (except for Malicious Code that may be uploaded by Users). In the event of breach of (i) , (ii) or (iv) above, Customer’s sole and exclusive remedy, and the sole and exclusive obligation of Immense Career, shall be to use commercially reasonable efforts to correct or provide a workaround for the reproducible error(s) that cause breach of these warranties, or  if Immense Career is unable to make the Hosted Service operate as warranted within a reasonable time considering the severity of the error and its impact on the Customer, Customer shall be entitled to terminate this Agreement and receive a pro-rata refund.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          9.1 &nbsp;&nbsp;&nbsp; IN NO EVENT SHALL THE AGGREGATE LIABILITY OF Immense Career OR ITS THIRD-PARTY PROVIDERS EXCEED THE TOTAL AMOUNTS ACTUALLY PAID BY AND/OR DUE FROM CUSTOMER IN THE TWELVE (12) MONTH PERIOD IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO SUCH CLAIM.
        </p>
        <p>
          9.2 &nbsp;&nbsp;&nbsp; IN NO EVENT SHALL EITHER PARTY OR THIRD-PARTY PROVIDERS OF Immense Career BE LIABLE TO ANYONE FOR ANY INDIRECT, PUNITIVE, SPECIAL, EXEMPLARY, INCIDENTAL, OR CONSEQUENTIAL DAMAGES, OR FOR ANY DAMAGES FOR LOSS OF DATA, REVENUE, PROFITS, USE OR OTHER ECONOMIC ADVANTAGE, ARISING OUT OF, OR IN ANY WAY CONNECTED WITH THIS AGREEMENT, INCLUDING BUT NOT LIMITED TO THE USE OR INABILITY TO USE THE HOSTED SERVICE, REGARDLESS OF CAUSE, WHETHER IN AN ACTION IN CONTRACT OR NEGLIGENCE OR OTHER TORTIOUS ACTION, EVEN IF THE PARTY FROM WHICH DAMAGES ARE BEING SOUGHT OR THE THIRD-PARTY PROVIDER HAVE BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
        </p>
        <p>
          9.3 &nbsp;&nbsp;&nbsp; THE LIMITATION OF LIABILITY SET FORTH IN THIS SECTION 9 SHALL NOT APPLY IN THE EVENT OF CUSTOMER’S INFRINGEMENT OR MISAPPROPRIATION OF Immense Career’S INTELLECTUAL PROPERTY RIGHTS, OR TO CUSTOMER’S INDEMNITY OBLIGATIONS SET FORTH IN SECTION 10 BELOW. CERTAIN STATES AND/OR JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF IMPLIED WARRANTIES OR LIMITATION OF LIABILITY FOR INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE EXCLUSIONS SET FORTH ABOVE MAY NOT APPLY.
        </p>
      </div>

      <div className="text-box">
        <h3>10. INDEMNITIES</h3>
        <p>
          10.1 &nbsp;&nbsp;&nbsp; Indemnification by Immense Career.  Immense Career shall defend, indemnify and hold Customer harmless against any “Claims” made or brought against Customer by a third party alleging that (i) the use of the Hosted Service as contemplated hereunder infringes the copyrights, trademarks or trade secrets of such third party; or (ii) Immense Career failed to comply with applicable laws, rules or regulations in its performance of this Agreement; provided, that Customer (a) promptly gives written notice of the Claim to Immense Career; (b) gives Immense Career control of the defense and settlement of the Claim (provided that Customer may participate in such defense at its own expense and that Immense Career may not settle any Claim in a manner that admits liability on behalf of Customer); and (c) provides to Immense Career, at Immense Career’s expense, reasonable assistance in connection with the defense and settlement of the Claim. Immense Career shall pay Customer any damages finally awarded against Customer, settlements agreed to in accordance with Section 10.1(b) and reasonable costs and expenses (including reasonable legal fees) directly attributable to such Claim.
        </p>
        <p>
          10.1.1 &nbsp;&nbsp;&nbsp; Immense Career may, at its sole option and expense: (i) procure for Customer the right to continue using the Hosted Service under the terms of this Agreement; or (ii) replace or modify the Hosted Service to be non-infringing without material decrease in functionality.  If the foregoing options are not reasonably practicable, Immense Career may terminate this Agreement and refund to Customer all prepaid fees for the remainder of its subscription term after the date of termination.  This Section 10 represents Immense Career’s entire obligation and Customer’s exclusive remedy regarding any third party intellectual property claims.
        </p>
        <p>
          10.1.2 &nbsp;&nbsp;&nbsp; Furthermore, Immense Career shall have no liability for any Claim under Section 10.1(i) to the extent such liability is the result of (i) modifications to the Hosted Service by anyone other than Immense Career or its agents (provided that Immense Career shall not be liable if Immense Career or its agents made the modifications using requirements documents, written specifications or other written materials submitted by Customer or its agents or representatives); (ii) the use or combination of the Hosted Service with any other item not provided by Immense Career where in the absence of such use or combination, the Hosted Service alone would not have given rise to the Claim; or (iii) Customer’s continued use of an infringing version of the Hosted Service when the then current version of the Hosted Service has been modified to be non-infringing.
        </p>
        <p>
          10.2 &nbsp;&nbsp;&nbsp; Indemnification by Customer. Customer shall defend, indemnify and hold Immense Career harmless against any Claims made or brought against Immense Career by a third party alleging that (i) Customer’s use of the Hosted Service in violation of this Agreement infringes or violates the rights of such third party; or (iii) Customer failed to comply with applicable laws, rules or regulations in its performance of this Agreement; provided, that Immense Career (a) promptly gives written notice of the Claim to Customer; (b) gives Customer control of the defense and settlement of the Claim (provided that Immense Career may participate in such defense at its own expense and that Customer may not settle any Claim in a manner that admits liability on behalf of Immense Career); and (c) provides to Customer, at Customer’s expense, reasonable assistance in connection with the defense and settlement of the Claim. Customer shall pay Immense Career any damages finally awarded against Immense Career, settlements agreed to in accordance with Section 10.2(b) and reasonable costs and expenses (including reasonable legal fees) directly attributable to such Claim.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          12.3 &nbsp;&nbsp;&nbsp; Upon any termination of this Agreement, the Receiving Party shall continue to maintain the confidentiality of the Disclosing Party’s Confidential Information for five (5) years and, upon request, return to the Disclosing Party or destroy (at the Disclosing Party’s election) all materials containing such Confidential Information.
        </p>
        <p>
          12.4 &nbsp;&nbsp;&nbsp; Immense Career’s obligations regarding information concerning Customer’s users shall be governed by the Terms and Conditions and Privacy Policy available on its website.  Immense Career tracks activity of users and applicants for the purpose of facilitating employment and recruiting efforts.
        </p>
      </div>

      <div className="text-box">
        <h3>13. CUSTOMER’S RESPONSIBILITIES</h3>
        <p>
          Customer will comply with all applicable local, state, national and foreign laws, treaties, regulations and conventions in connection with its use of the Hosted Service, including without limitation those related to data privacy, international communications, and the exportation of technical or personal data from locations other than the location from which Immense Career controls and operates the Hosted Services. Customer will ensure that any use of the Hosted Services by Customer’s Users is in accordance with the terms of this Agreement.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          14.1 &nbsp;&nbsp;&nbsp; If Customer is a federal government entity, Immense Career provides the Hosted Service, including related software and technology, for ultimate federal government end use solely in accordance with the appropriate regulations.
        </p>
        <p>
        ...
        <p>
          14.10 &nbsp;&nbsp;&nbsp; Immense Career may give notice by means of a Customer Notification on the Hosted Service; electronic mail to Customer’s e-mail address on record in Immense Career’s account information, or by written communication sent by first class mail or pre-paid post to Customer’s address on the Hosted Service. Customer may give notice to Immense Career at any time by letter sent by email to support@Immense Career.com or by letter delivered first class mail to Immense Career at 25 West 39th St., 7 Floor, New York, NY 10018.
        </p>
        <p>
          14.11 &nbsp;&nbsp;&nbsp; The failure of either Party to enforce any right or provision in this Agreement shall not constitute a waiver of such right or provision unless acknowledged and agreed to by such party in writing. In the event of any litigation of any controversy or dispute arising out of or in connection with this Agreement, its interpretation, its performance, or the like, the prevailing party shall be awarded reasonable attorneys’ fees and expenses, court costs, and reasonable costs for expert and other witnesses attributable to the prosecution or defense of that controversy or dispute. Any rights not expressly granted herein are reserved by Immense Career.
        </p>
        <p>
          14.12 &nbsp;&nbsp;&nbsp; Immense Career reserves the right to alter the terms of this Agreement at any time. If the alterations constitute a “material change” to the Agreement, Immense Career will notify Customer. What constitutes a “material change” will be determined at Immense Career’s sole discretion, in good faith and using common sense and reasonable judgment, but will only include those changes that materially affect Customer’s use of the Hosted Services or rights under this Agreement. Notice will be considered to have been delivered once sent.  Customer agrees to review the latest version of the Agreement on Immense Career’s website periodically to remain aware of any non-material modifications to the Agreement about which Customer is not alerted by Immense Career.  The Agreement available on the website will be dated so as to make clear what version is currently in force.  Any use of the Hosted Services after alteration of the Agreement will constitute acceptance by Customer of such changes. Customer’s sole remedy should Customer not agree with the altered Agreement shall be to cease Customer’s use of the Hosted Services and to comply with Customer’s termination obligations outlined in Section 11 of this Agreement.
        </p>
      </div>
    </>
  );
